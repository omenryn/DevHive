    ...
    return (
        <aside className={`hidden lg:block space-y-6 ios-glass ios-glass-border ios-glass-shadow p-6 rounded-xl h-fit sticky top-24 ${className}`}>
            <nav className="space-y-2">
                <a className="flex items-center gap-3 p-3 rounded-lg ios-hover-active text-primary font-bold transition-colors" href="#">
                    <span className="material-symbols-rounded">dynamic_feed</span>
                    <span>Feed</span>
                </a>
                <a className="flex items-center gap-3 p-3 rounded-lg ios-hover transition-colors" href="#">
            ...
            <div className="pt-4 border-t border-white/40 dark:border-primary/20">
                ...
                <div className="space-y-2">
                    <a className="flex items-center gap-3 p-2 rounded-lg ios-hover transition-colors text-sm" href="#">

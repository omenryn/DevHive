...
const Navbar = () => {
    return (
        <header className="sticky top-0 z-50 bg-background-light/90 dark:bg-background-dark/90 backdrop-blur-xl border-b border-slate-200/50 dark:border-primary/20 px-4 md:px-8 py-3 shadow-sm">
